...
/*
shows the code for counting the number of agencies in each state 
that moved, had a minor address change, or had no change 
using GROUP BY with stabr and stataddr and adding count()*/

-- Be sure to connect to Analysis DATABASE
...
-- Groupping visit stats by state
SELECT pls14.stabr,
